      ...
      try {
        await prisma.vocabularyWord.create({
          data: {
            ...
            synonyms: vocabData.synonyms.length > 0 ? JSON.stringify(vocabData.synonyms) : null,
            antonyms: vocabData.antonyms.length > 0 ? JSON.stringify(vocabData.antonyms) : null,
            tags: vocabData.tags.length > 0 ? JSON.stringify(vocabData.tags) : null,
