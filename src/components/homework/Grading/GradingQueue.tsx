      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3 text-sm">
          <div className="flex items-center gap-1">
            ...
            <span>
              {submission.completedExercises}/{submission.totalExercises} 练习
            </span>
          </div>
          <div className="flex items-center gap-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <span>
              {submission.score || 0}/{submission.homework?.totalPoints || 100}{' '}
              分
            </span>
          </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-2">
            {submission.homework?.exercises?.map(
    ...
    <div className="space-y-6">
      ...
      {submissions.length === 0 ? (
        <Card className="p-8 text-center">
          ...
          <p className="text-gray-600">当前没有符合条件的提交需要批改。</p>
        </Card>
      ) : (
        <div className="space-y-4">{submissions.map(renderSubmissionCard)}</div>
      )}
    </div>
  )
}
