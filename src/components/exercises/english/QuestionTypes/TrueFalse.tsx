    ...
    <div className="space-y-4">
      ...
      <div className="p-3 bg-gray-50 border border-gray-200 rounded-md">
        <p className="text-sm text-gray-700">
          <strong>Instructions:</strong> Choose one of the three options based
          on the information in the text:
        </p>
        <ul className="text-xs text-gray-600 mt-2 space-y-1">
          <li>
            • <strong>True:</strong> The statement matches the information in
            the text
          </li>
          <li>
            • <strong>False:</strong> The statement contradicts the information
            in the text
          </li>
          <li>
            • <strong>Not Given:</strong> The information is not mentioned in
            the text
          </li>
        </ul>
      </div>
      ...
      {selectedAnswer && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
          <p className="text-sm text-blue-800">
            ...
            {options.find(opt => opt.value === selectedAnswer)?.label}
          </p>
        </div>
      )}
    </div>
