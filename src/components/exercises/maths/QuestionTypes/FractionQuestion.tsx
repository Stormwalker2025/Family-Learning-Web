...
export const FractionQuestion: React.FC<FractionQuestionProps> = ({
  ...
  const renderFractionVisual = () => {
    ...
    const segments = []
    const segmentSize =
      visualType === 'circle' ? 360 / totalParts : 200 / totalParts
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <div className="text-sm font-medium">
          Drag fractions to match the pictures:
        </div>
              ...
              {visual.type === 'circle' && (
                <svg width="80" height="80">
                  {Array.from({ length: visual.total }).map((_, i) => {
                    ...
                    const nextAngle =
                      ((((i + 1) * 360) / visual.total) * Math.PI) / 180
          ...
          <div className="flex items-center justify-center gap-8">
            <div className="text-center">
              <div className="text-2xl font-bold font-mono mb-2">
                {problemData.fraction1.numerator}/
                {problemData.fraction1.denominator}
              </div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold font-mono mb-2">
                {problemData.fraction2.numerator}/
                {problemData.fraction2.denominator}
              </div>
              <div className="text-sm text-gray-600">
                ={' '}
                {(
  ...
  const renderDrawing = () => (
    <div className="space-y-4">
      ...
      <div className="bg-white border-2 border-gray-300 rounded-lg p-4">
        <div className="text-center mb-4">
          <div className="text-sm text-gray-600 mb-2">
            Draw and shade to show: {problemData?.targetFraction?.numerator}/
            {problemData?.targetFraction?.denominator}
          </div>
          ...
          >
            ...
            >
              Click to draw and shade {problemData?.targetFraction?.numerator}/
              {problemData?.targetFraction?.denominator}
            </text>
          </svg>
        </div>
      ...
      <div className="text-center">
        <Button onClick={() => setUserAnswer('drawn')}>Submit Drawing</Button>
      </div>
    ...
    <Card className={`p-6 ${className}`}>
      <div className="space-y-6">
        ...
        <div>
          ...
          {question.type === 'fraction-visual' &&
            renderFractionVisualQuestion()}
