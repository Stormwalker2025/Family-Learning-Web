...
const getMockMapData = (mapId: string): InteractiveMapData => {
      ...
      markers: [
        {
          ...
          category: 'capital',
          popup: 'Sydney is Australia\'s largest city and the capital of New South Wales. Home to the iconic Sydney Opera House and Harbour Bridge.'
        },
        {
          id: 'melbourne',
          ...
          category: 'capital',
          popup: 'Melbourne is the capital of Victoria and Australia\'s cultural capital, known for its coffee culture and street art.'
        },
        {
          id: 'brisbane',
          ...
          category: 'capital',
          popup: 'Brisbane is the capital of Queensland and gateway to the Gold Coast and Sunshine Coast.'
        },
        {
          id: 'perth',
          ...
          category: 'capital',
          popup: 'Perth is the capital of Western Australia and one of the most isolated major cities in the world.'
        },
        {
          id: 'adelaide',
          ...
          category: 'capital',
          popup: 'Adelaide is the capital of South Australia, known as the "City of Churches" and famous for its wine regions.'
        },
        {
          id: 'hobart',
          ...
          category: 'capital',
          popup: 'Hobart is the capital of Tasmania and Australia\'s second-oldest capital city.'
        },
        {
          id: 'canberra',
          position: [-35.2809, 149.1300] as [number, number],
          title: 'Canberra',
          description: 'National Capital',
          category: 'national-capital',
          popup: 'Canberra is Australia\'s national capital and home to Parliament House and many national institutions.'
        },
        {
          id: 'darwin',
          ...
          category: 'capital',
          popup: 'Darwin is the capital of the Northern Territory and Australia\'s gateway to Asia.'
        }
      ],
      regions: [
        {
          ...
          coordinates: [[-28.5, 141.0], [-37.5, 141.0], [-37.5, 153.6], [-28.5, 153.6]],
      ...
      markers: [
        {
          ...
          popup: 'The Yolŋu people are the traditional owners of northeast Arnhem Land in the Northern Territory.'
        },
        {
          id: 'arrernte',
          ...
          category: 'language-group',
          popup: 'The Arrernte people are the traditional custodians of Mparntwe (Alice Springs) and surrounding areas.'
        }
      ],
      regions: []
    }
  ...
  return mapConfigs[mapId as keyof typeof mapConfigs] || mapConfigs['australia-states-map']
}
      ...
      <CardContent>
        ...
        >
          ...
          <svg
            ...
            style={{ transform: `scale(${zoom / 4}) translate(${(center[1] + 135) * 2}px, ${(center[0] + 25) * 3}px)` }}
          >
            ...
            {/* Tasmania */}
            <circle cx="280" cy="270" r="15" fill="rgba(34, 197, 94, 0.3)" stroke="rgba(34, 197, 94, 0.8)" strokeWidth="2" />
          </svg>
          ...
          {selectedMarker && (
            <div className="absolute bottom-4 left-4 right-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border">
              <div className="flex items-start justify-between">
                <div>
                  <h4 className="font-semibold text-lg">{selectedMarker.title}</h4>
          ...
          {showInfo && (
            <div className="absolute top-4 right-4 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg border max-w-xs">
              ...
              <div className="text-sm space-y-1">
                <p><span className="font-medium">Zoom:</span> {zoom}x</p>
                <p><span className="font-medium">Center:</span> {center[0].toFixed(1)}°, {center[1].toFixed(1)}°</p>
                <p><span className="font-medium">Markers:</span> {mapData.markers.length}</p>
                <p><span className="font-medium">Active Layers:</span> {visibleLayers.size}</p>
              </div>
            </div>
          )}
