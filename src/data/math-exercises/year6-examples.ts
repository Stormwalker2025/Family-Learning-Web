...
export const year6MathExercises: MathExercise[] = [
  {
    ...
    description:
      'Understanding place value in large numbers and decimal numbers using real Australian data',
    topic: 'place-value',
    yearLevel: 6,
    ...
    conceptIntro: {
      ...
      explanation:
        'Place value extends both left (for larger numbers) and right (for decimal numbers). In 2,547,836.254, each digit has a specific place and value. Understanding this helps us work with real-world data like population statistics and precise measurements.',
      examples: [
        {
          id: 'pv-example-large',
          description: 'Australian Population',
          problem:
            "Australia's population is approximately 25,690,000. What is the value of the digit 6?",
          solution:
      ...
      keyTerms: [
        ...
        {
          term: 'Hundred thousands',
          definition: '100,000 - ten ten-thousands',
        },
        {
          term: 'Tenths',
          definition: 'First decimal place, one part of ten equal parts',
        },
        {
          term: 'Hundredths',
          definition:
            'Second decimal place, one part of one hundred equal parts',
        },
        {
          term: 'Thousandths',
          definition:
            'Third decimal place, one part of one thousand equal parts',
        },
      ],
      visualAids: [
        {
    ...
    questions: [
      {
        ...
        question:
          "Sydney's population is 5,312,163. What is the value of the digit 3 in the ten thousands place?",
        instructions:
          "Locate the ten thousands place and determine the digit's value.",
        problemData: {
          number: 5312163,
        ...
        explanation:
          'In 5,312,163, the digit 1 is in the ten thousands place (value 10,000). The digit 3 appears in two places: hundreds (300) and hundred thousands (300,000).',
        points: 25,
        order: 1,
        difficulty: 'proficient',
        estimatedTime: 3,
      ...
      },
      {
        ...
        explanation:
          '4,567,892 = 4,000,000 + 500,000 + 60,000 + 7,000 + 800 + 90 + 2',
        points: 30,
        order: 2,
        difficulty: 'proficient',
        estimatedTime: 4,
      ...
      },
      {
        ...
        type: 'multiple-choice',
        question:
          'In the decimal 23.847, which digit is in the hundredths place?',
        instructions:
          'Remember: tenths, hundredths, thousandths go from left to right after the decimal point.',
        problemData: {
          number: 23.847,
        ...
        explanation:
          'In 23.847, the digit 4 is in the hundredths place. The order is: 8 (tenths), 4 (hundredths), 7 (thousandths).',
        points: 20,
        order: 3,
      ...
      },
      {
        ...
        instructions:
          'Look at the digit in the ten thousands place to decide whether to round up or down.',
        problemData: {
          number: 2847359,
        ...
        explanation:
          '2,847,359 rounded to the nearest hundred thousand is 2,800,000 because the ten thousands digit (4) is less than 5.',
        points: 25,
        order: 4,
        difficulty: 'proficient',
        estimatedTime: 3,
      ...
      },
      {
        ...
        type: 'drag-drop',
        question:
          'Order these decimal numbers from smallest to largest: 12.67, 12.076, 12.6, 12.706',
        instructions:
          'Compare decimal numbers by looking at each decimal place from left to right.',
        problemData: {
        ...
        explanation:
          'Ordering: 12.076 (smallest), then 12.6 (=12.600), then 12.67 (=12.670), then 12.706 (largest).',
        points: 20,
        order: 5,
        difficulty: 'advanced',
        estimatedTime: 4,
...

  {
    ...
    description:
      'Working with fraction operations, equivalent fractions, and mixed numbers',
    topic: 'fractions',
    yearLevel: 6,
    difficulty: 'proficient',
    timeLimit: 30,
    ...
    conceptIntro: {
      ...
      explanation:
        'Fractions can be added, subtracted, and compared. To add fractions with different denominators, we need to find equivalent fractions with the same denominator. Mixed numbers combine whole numbers with fractions.',
      examples: [
        {
          id: 'frac-example-addition',
          description: 'Adding Fractions with Different Denominators',
          problem:
            'A recipe calls for 1/3 cup of flour and 1/4 cup of sugar. How much dry ingredients in total?',
      ...
      keyTerms: [
        {
          ...
          definition:
            'Fractions that represent the same value, like 1/2 = 2/4 = 3/6',
        },
        {
          term: 'Common denominator',
          definition:
            'The same bottom number used when adding or subtracting fractions',
        },
        {
          term: 'Mixed number',
          definition:
            'A number with a whole part and a fraction part, like 2 1/3',
        },
        {
      ...
      visualAids: [
        {
          ...
          description:
            'Visual representation of adding and subtracting fractions',
          interactiveData: {
    ...
    questions: [
      {
        ...
        explanation:
          '9/12 is equivalent to 3/4 because both fractions reduce to 3/4 when simplified (9÷3 = 3, 12÷3 = 4).',
        points: 20,
        order: 1,
        difficulty: 'developing',
        estimatedTime: 3,
      ...
      },
      {
        ...
        problemData: {
          ...
          operation: 'add',
          context:
            'Adding portions of a sports field covered by different teams',
        },
        correctAnswer: '11/15',
        hints: [
        ...
        explanation:
          '2/5 + 1/3: Common denominator is 15. 2/5 = 6/15, 1/3 = 5/15. So 6/15 + 5/15 = 11/15.',
        points: 25,
        order: 2,
        difficulty: 'proficient',
        estimatedTime: 4,
      ...
      },
      {
        ...
        explanation:
          '17 ÷ 5 = 3 remainder 2, so 17/5 = 3 2/5 (3 whole parts and 2/5 left over).',
        points: 20,
        order: 3,
        difficulty: 'developing',
        estimatedTime: 3,
      ...
      },
      {
        ...
        type: 'calculation',
        question:
          'A pizza is cut into 8 pieces. Tom eats 3/8 of the pizza and Sarah eats 2/8. What fraction of the pizza is left?',
        instructions:
          'Add the fractions eaten, then subtract from the whole pizza.',
        problemData: {
        ...
        explanation:
          'Total eaten: 3/8 + 2/8 = 5/8. Pizza left: 8/8 - 5/8 = 3/8.',
        points: 25,
        order: 4,
        difficulty: 'proficient',
        estimatedTime: 4,
      ...
      },
      {
        ...
        instructions:
          'Compare the fractions by finding equivalent fractions with common denominators.',
        problemData: {
        ...
        explanation:
          'True. Using common denominator 20: 3/4 = 15/20 and 7/10 = 14/20. Since 15/20 > 14/20, we have 3/4 > 7/10.',
        points: 30,
        order: 5,
        difficulty: 'advanced',
        estimatedTime: 5,
...

  {
    ...
    description:
      'Calculate area and perimeter of rectangles, triangles, and composite shapes in real contexts',
    topic: 'area',
    yearLevel: 6,
    difficulty: 'proficient',
    timeLimit: 35,
    ...
    conceptIntro: {
      ...
      explanation:
        'Area measures the space inside a shape (square units like m²). Perimeter measures the distance around the outside (linear units like m). These concepts help us plan spaces, buy materials, and solve practical problems.',
      examples: [
        {
          id: 'area-example-playground',
          description: 'School Playground Planning',
          problem:
            'A rectangular playground is 30m long and 20m wide. What is its area and perimeter?',
      ...
      keyTerms: [
        ...
        {
          term: 'Perimeter',
          definition: 'The distance around the outside edge of a 2D shape',
        },
        {
          term: 'Square metre (m²)',
          definition: 'Standard unit for measuring area - a square 1m × 1m',
        },
        {
          term: 'Composite shape',
          definition: 'A shape made by combining two or more simple shapes',
        },
        {
          term: 'Formula',
          definition:
            'A mathematical rule or equation, like Area = length × width',
        },
      ],
      visualAids: [
        {
          ...
          description:
            'Interactive tool showing area and perimeter calculations',
          interactiveData: {
    ...
    questions: [
      {
        ...
        type: 'calculation',
        question:
          'A rectangular basketball court is 28m long and 15m wide. Calculate its area.',
        ...
        explanation:
          'Area = 28m × 15m = 420 m². The basketball court covers 420 square metres.',
        points: 20,
        order: 1,
      ...
      },
      {
        ...
        type: 'calculation',
        question:
          'The same basketball court needs new fencing around the perimeter. How many metres of fencing are needed?',
        instructions:
          'Calculate the perimeter using: Perimeter = 2 × (length + width)',
        problemData: {
          shape: 'rectangle',
          length: 28,
          width: 15,
        ...
        explanation:
          'Perimeter = 2 × (28m + 15m) = 2 × 43m = 86m. They need 86 metres of fencing.',
        points: 20,
        order: 2,
        difficulty: 'foundation',
        estimatedTime: 3,
      ...
      },
      {
        ...
        type: 'calculation',
        question:
          'A triangular garden bed has a base of 12m and height of 8m. What is its area?',
        ...
        explanation:
          'Area = ½ × 12m × 8m = ½ × 96 m² = 48 m². The triangular garden covers 48 square metres.',
        points: 25,
        order: 3,
        difficulty: 'developing',
        estimatedTime: 4,
      ...
      },
      {
        ...
        type: 'calculation',
        question:
          'A playground consists of a rectangle (20m × 15m) with a square sandbox (5m × 5m) attached to one side. What is the total area?',
        instructions:
          'Calculate the area of each shape separately, then add them together.',
        problemData: {
          shapes: [
        ...
        explanation:
          'Rectangle: 20m × 15m = 300 m². Square: 5m × 5m = 25 m². Total: 300 + 25 = 325 m².',
        points: 30,
        order: 4,
        difficulty: 'proficient',
        estimatedTime: 5,
      ...
      },
      {
        ...
        question:
          'A square courtyard has sides of 800cm. Convert this to metres and calculate the area in square metres.',
        instructions:
          'First convert centimetres to metres, then calculate the area.',
        problemData: {
          shape: 'square',
          sideCm: 800,
        ...
        explanation:
          '800 cm = 8 m (divide by 100). Area = 8m × 8m = 64 m². The courtyard area is 64 square metres.',
        points: 25,
        order: 5,
        difficulty: 'advanced',
        estimatedTime: 4,
