...
export const year3MathExercises: MathExercise[] = [
  {
    ...
    description: 'Understanding place value in three-digit numbers using Australian contexts',
    topic: 'place-value',
    yearLevel: 3,
    ...
    conceptIntro: {
      ...
      explanation: 'In our number system, the position of a digit tells us its value. In the number 345, the 3 is in the hundreds place (worth 300), the 4 is in the tens place (worth 40), and the 5 is in the ones place (worth 5).',
      examples: [
        {
          id: 'pv-example-1',
          description: 'Brisbane Population',
          problem: 'Brisbane has about 2,500,000 people. What is the value of the 5?',
          solution: 'The 5 is in the hundred thousands place, so its value is 500,000',
          steps: [
            {
              id: 'step1',
              stepNumber: 1,
      ...
      keyTerms: [
        { term: 'Hundreds place', definition: 'The third digit from the right in a number' },
        { term: 'Tens place', definition: 'The second digit from the right in a number' },
        { term: 'Ones place', definition: 'The first digit from the right in a number' },
      ...
      visualAids: [
        {
          ...
          description: 'Interactive chart showing hundreds, tens, and ones columns',
          interactiveData: {
    ...
    questions: [
      {
        ...
        instructions: 'Look at the position of the digit 4 and determine its place value.',
        problemData: {
          number: 247,
          targetDigit: 4,
        ...
        explanation: 'The digit 4 is in the tens place, so its value is 4 × 10 = 40.',
        points: 20,
        order: 1,
        difficulty: 'foundation',
        estimatedTime: 2,
      ...
      },
      {
        ...
        instructions: 'Drag the correct digits to the hundreds, tens, and ones places.',
        problemData: {
          targetNumber: 583,
        ...
        explanation: '583 = 500 + 80 + 3, so we need 5 in hundreds, 8 in tens, and 3 in ones.',
        points: 25,
        order: 2,
      ...
      },
      {
        ...
        explanation: '600 + 70 + 9 = 679. This is how we write numbers in standard form.',
        points: 20,
        order: 3,
        difficulty: 'foundation',
        estimatedTime: 2,
      ...
      },
      {
        ...
        explanation: 'False. The digit 3 is in the hundreds place, so its value is 300, not 30.',
        points: 15,
        order: 4,
        difficulty: 'foundation',
        estimatedTime: 2,
      ...
      },
      {
        ...
        instructions: 'Compare the numbers by looking at each place value from left to right.',
        problemData: {
          numbers: [234, 243],
        ...
        explanation: 'Both numbers have 2 hundreds, but 243 has 4 tens while 234 has 3 tens, so 243 > 234.',
        points: 20,
        order: 5,
        difficulty: 'developing',
        estimatedTime: 3,
...

  {
    ...
    description: 'Understanding basic fractions through sharing and visual representations',
    topic: 'fractions',
    yearLevel: 3,
    difficulty: 'foundation',
    timeLimit: 20,
    ...
    conceptIntro: {
      ...
      explanation: 'A fraction shows equal parts of a whole. When we share something fairly, we create fractions. 1/2 means 1 out of 2 equal parts.',
      examples: [
        {
          id: 'frac-example-1',
          description: 'Sharing a Pizza',
          problem: 'Tom and Sarah share a pizza equally. What fraction does each person get?',
      ...
      keyTerms: [
        { term: 'Fraction', definition: 'A number that represents part of a whole' },
        { term: 'Numerator', definition: 'The top number in a fraction (how many parts we have)' },
        { term: 'Denominator', definition: 'The bottom number in a fraction (how many equal parts in total)' },
        { term: 'Unit fraction', definition: 'A fraction with 1 as the numerator, like 1/2, 1/3, 1/4' }
      ],
      visualAids: [
        {
          id: 'fraction-circles',
    ...
    questions: [
      {
        ...
        explanation: 'There is 1 shaded part out of 4 equal parts, so the fraction is 1/4.',
        points: 20,
        order: 1,
        difficulty: 'foundation',
        estimatedTime: 3,
      ...
      },
      {
        ...
        explanation: 'Each fraction matches the visual with the same number of total parts and one shaded part.',
        points: 30,
        order: 2,
        difficulty: 'developing',
        estimatedTime: 5,
      ...
      },
      {
        ...
        exerciseId: 'math-year3-fractions-1',
        type: 'multiple-choice',
        question: 'Three friends share a cake equally. What fraction does each friend get?',
        instructions: 'Think about how to divide one whole cake among three people.',
        problemData: {
          totalItems: 1,
          numberOfPeople: 3,
        ...
        explanation: 'When 3 friends share 1 cake equally, each friend gets 1/3 of the cake.',
        points: 20,
        order: 3,
        difficulty: 'foundation',
        estimatedTime: 3,
      ...
      },
      {
        ...
        instructions: 'Think about which fraction represents a larger part of the same whole.',
        problemData: {
        ...
        explanation: 'True. 1/2 (half) is larger than 1/4 (quarter). When you divide something into fewer parts, each part is bigger.',
        points: 15,
        order: 4,
        difficulty: 'developing',
        estimatedTime: 3,
      ...
      },
      {
        ...
        instructions: 'Divide the rectangle into 2 equal parts and shade 1 part.',
        problemData: {
          shape: 'rectangle',
        ...
        explanation: 'Divide the rectangle into 2 equal parts and shade 1 part. This shows 1/2.',
        points: 15,
        order: 5,
        difficulty: 'developing',
        estimatedTime: 4,
...

  {
    ...
    description: 'Working with Australian currency - counting, adding, and making change',
    topic: 'decimals',
    yearLevel: 3,
    difficulty: 'foundation',
    timeLimit: 25,
    ...
    conceptIntro: {
      ...
      explanation: 'Australia uses dollars and cents. 100 cents = $1. We write money amounts with a dollar sign and decimal point, like $3.50 (3 dollars and 50 cents).',
      examples: [
        {
          id: 'money-example-1',
          description: 'Counting Coins',
          problem: 'You have 2 × $1 coins, 1 × 50c coin, and 3 × 10c coins. How much money do you have?',
          solution: '$2.80',
          steps: [
            {
              id: 'step1',
      ...
      keyTerms: [
        { term: 'Dollar', definition: 'The main unit of Australian currency, written as $' },
        { term: 'Cent', definition: 'Smaller unit of Australian currency, 100 cents = $1' },
        { term: 'Decimal point', definition: 'The dot that separates dollars from cents in money amounts' },
        { term: 'Change', definition: 'Money given back when you pay more than the cost of an item' }
      ],
      visualAids: [
        {
          id: 'australian-money',
    ...
    questions: [
      ...
      },
      {
        ...
        exerciseId: 'math-year3-money-1',
        type: 'input-answer',
        question: 'You buy a drink for $1.50 and pay with a $2 coin. How much change do you get?',
        ...
        explanation: 'Change = $2.00 - $1.50 = $0.50. You would get one 50c coin as change.',
        points: 20,
        order: 2,
        difficulty: 'developing',
        estimatedTime: 3,
      ...
      },
      {
        ...
        instructions: 'Drag coins to make the target amount with the smallest number of coins.',
        problemData: {
          targetAmount: 3.75,
          availableCoins: [
        ...
        explanation: 'The fewest coins: $2 + $1 + 50c + 20c + 5c = $3.75 (5 coins total)',
        points: 30,
        order: 3,
      ...
      },
      {
        ...
        explanation: '$2.80 is greater than $2.08 because 80 cents is more than 8 cents (or 08 cents).',
        points: 15,
        order: 4,
        difficulty: 'foundation',
        estimatedTime: 2,
      ...
      },
      {
        ...
        exerciseId: 'math-year3-money-1',
        type: 'calculation',
        question: 'Sarah has $4.25. She buys a pencil for $1.20 and an eraser for $0.85. How much money does she have left?',
        instructions: 'Add the costs, then subtract from the total amount.',
        problemData: {
          startingAmount: 4.25,
          purchases: [
            { item: 'pencil', cost: 1.20 },
        ...
        explanation: 'Total spent: $1.20 + $0.85 = $2.05. Money left: $4.25 - $2.05 = $2.20.',
        points: 10,
        order: 5,
        difficulty: 'developing',
        estimatedTime: 4,
